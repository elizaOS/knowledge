...
An elizaOS project is the top-level workspace for a product such as Milady. It is where you:
...
Project-specific environment variables should use your configured `envPrefix`. For example, Milady uses `MILADY_*` in addition to compatibility aliases where needed.
