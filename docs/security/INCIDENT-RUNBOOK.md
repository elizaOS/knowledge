> **Mirror.** Authoritative copy lives in the outer milady monorepo at `milady/docs/security/INCIDENT-RUNBOOK.md`. Relative links below (`../../POLICIES/...`) resolve in the outer monorepo, not inside this submodule.
