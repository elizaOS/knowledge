...
<Tabs>
  <Tab title="TypeScript">
    ...
    ```bash
    bun -e "import { AgentRuntime } from '@elizaos/core'; console.log('elizaOS installed!')"
    ```
    ...
    <Tip>
      Clone the monorepo for examples and development: `git clone https://github.com/elizaos/eliza.git`. Check the `examples/` directory for working agent implementations.
    </Tip>
