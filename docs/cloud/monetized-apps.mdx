...
Use [Cloud → Monetization](https://cloud.eliza.app/cloud/monetization), or call the redemptions API. Earnings are tracked in dollars; redemptions use `pointsAmount`, where 100 points equals $1.00.
