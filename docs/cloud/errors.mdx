...
2. Check the key hasn't been revoked in [Cloud → API Keys](https://cloud.eliza.app/cloud/api-keys)
...
3. Upgrade your plan for higher limits at [Cloud → Billing](https://cloud.eliza.app/cloud/billing)
...
1. Check your balance at [Cloud → Billing](https://cloud.eliza.app/cloud/billing)
...
1. Verify character JSON is valid with the [API Explorer](https://cloud.eliza.app/cloud/api-explorer)
