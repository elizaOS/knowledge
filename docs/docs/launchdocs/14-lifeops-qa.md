...
- Remote sessions: `plugins/app-lifeops/src/actions/owner-remote-desktop.ts:54`, `plugins/app-lifeops/src/remote/remote-session-service.ts:1`, `plugins/app-lifeops/src/remote/remote-session-service.ts:148`, `plugins/app-lifeops/src/remote/tailscale-transport.ts:109`.
