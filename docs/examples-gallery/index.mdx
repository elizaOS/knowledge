...
<CardGroup cols={2}>
  ...
  <Card title="HTML ELIZA" icon="code" href="/examples-gallery/web-apps#html-example">
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="react"
    href="/examples-gallery/web-apps#nextjs-example"
  >
...
<CardGroup cols={2}>
  <Card
    title="React + PGLite"
    icon="react"
    href="/examples-gallery/web-apps#react-example"
  >
