...
| --------------------------------- | --------- | ---------- | ---------------- |
| [AWS Lambda](#aws-lambda)         | TypeScript | 2-5s       | 1M requests      |
| [GCP Cloud Functions](#gcp)       | TypeScript | 2-5s       | 2M invocations   |
| [Vercel Edge](#vercel)            | TypeScript | <50ms      | 100K requests    |
| [Cloudflare Workers](#cloudflare) | TypeScript | <10ms      | 100K requests    |
| [Supabase Edge](#supabase)        | TypeScript (Deno), optional WASM | <100ms | 500K invocations |
...
| Languages   | TypeScript | TypeScript | TypeScript | TypeScript | TS (+ optional WASM) |
...
<CardGroup cols={2}>
  ...
  <Card title="Deploy Guide" icon="rocket" href="/deployment">
