...
The [apps view](/dashboard/apps) ships with new hero artwork across the catalog, including a dedicated ClawVille tile. The desktop splash screen has also been updated so first-run feels fresher before your agent finishes booting.
