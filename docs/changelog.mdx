...
**Docs:** [Plugin resolution — pinned OpenRouter](/plugin-resolution-and-node-path#pinned-elizaosplugin-openrouter), [OpenRouter registry page](/plugins/overview#eliza-pinned-version-and-upstream-bundle-bug), root `README.md` (upstream note), and `docs/roadmap.md` (done item).
...
Developer guide: [First-run flow](/guides/first-run-flow).
...
See the same guide: [First-run flow](/guides/first-run-flow) (section *Connection step subflow*).
...
Docs: [Desktop app](/apps/desktop) (application menu), [First-run flow](/guides/first-run-flow).
</Update>
