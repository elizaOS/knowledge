...
- **Life-ops onboarding polish** — The life-ops page now shows a welcome card with capability tiles and friendlier empty states when no data is connected yet, making it easier to discover and set up integrations.
