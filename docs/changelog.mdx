...
- **Wallet setup available inline** — The [wallet](/guides/wallet) page now shows Steward status and setup options directly instead of redirecting you to settings. Each wallet section handles its own unconfigured state, so you always see the full layout with contextual setup prompts.
