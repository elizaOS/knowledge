...
description: "Popular Eliza agent archetypes — pick a starting point, ship anything."
---

A sample of agent archetypes you can ship on elizaOS. Each card lists the plugins it pulls in.
