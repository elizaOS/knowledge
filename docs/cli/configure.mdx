...
This command does not accept flags. For reading and writing config values, use [`eliza config`](/cli/config). For interactive key setup, use [`eliza setup`](/cli/setup).
