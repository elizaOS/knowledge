...
| 7 | **Desktop-bar** | Workstream H: Wispr-style bottom bar, Ctrl-Space, push-to-talk, Fn handling, always-on glow | `packages/ui/src/desktop-runtime/*`, `packages/native-plugins/desktop/*`, `packages/app/src/main.tsx` | `CompanionBar` | `ELIZA_DESKTOP_COMPANION_BAR` |
