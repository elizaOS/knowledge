...
Re-download from the official [GitHub releases](https://github.com/eliza-ai/eliza/releases/latest) page if Gatekeeper or notarization warnings look suspicious.
...
Issue tracker: [eliza-ai/eliza issues](https://github.com/eliza-ai/eliza/issues)
