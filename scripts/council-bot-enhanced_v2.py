...
class CouncilBotV2(commands.Bot):
    ...
    async def post_briefing_command_v2(self, ctx, briefing_file: str = None):
        if not briefing_file:
            ...
            briefing_file = os.getenv('BRIEFING_FILE_V2', 'the-council/council_briefing/daily_v2.json') 
...
def main():
    ...
    parser.add_argument("--briefing-file", help="Path to V2 council briefing JSON file (e.g., the-council/council_briefing/YYYY-MM-DD_v2.json)")
