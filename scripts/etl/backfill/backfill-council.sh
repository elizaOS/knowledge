...
#
# Usage:
#   ./scripts/etl/backfill/backfill-council.sh                    # Default: 2024-10-15 to 2025-04-17
#   ./scripts/etl/backfill/backfill-council.sh 2025-01-01         # Single day: 2025-01-01
#   ./scripts/etl/backfill/backfill-council.sh 2025-01-01 2025-01-31  # Custom range
#
# Environment:
